...
/*   Updated: 2023/08/02 19:45:12 by gabrrodr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
        put_tile(game, "./textures/taytaygrabB.xpm", game->player.x * SIZE, game->player.y * SIZE);
        usleep(40000);
        put_tile(game, "./textures/taytaygrabB1.xpm", game->player.x * SIZE, game->player.y * SIZE);
        usleep(40000);
        put_tile(game, "./textures/taytaygrabB2.xpm", game->player.x * SIZE, game->player.y * SIZE);
        usleep(40000);
        put_tile(game, "./textures/taytaygrabB1.xpm", game->player.x * SIZE, game->player.y * SIZE);
        usleep(120000);
        put_tile(game, "./textures/taytay.xpm", game->player.x * SIZE, game->player.y * SIZE);
